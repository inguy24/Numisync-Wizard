...
- **NumiSync Wizard instalado** ([Guia de Instalação](/pt-BR/installation))
...
**Dica Pro:** Adquira uma [Licença de Apoiador](/pt-BR/license) para usar o **Fast Pricing Mode** — atualiza todas as moedas identificadas instantaneamente!
...
Adquira uma **[Licença de Apoiador ($10)](/pt-BR/license)** para desbloquear:
...
<div style="text-align: center; margin: 2em 0;">
  <a href="/pt-BR/installation" style="display: inline-block; padding: 10px 20px; background: #6c757d; color: white; text-decoration: none; border-radius: 6px;">← Guia de Instalação</a>
